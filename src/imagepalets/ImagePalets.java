...
//            System.out.println("Voici Lk-----");
//            PrintPixelsList(Lk);
//            System.out.println("Voici newPalette-----");
//            PrintPixelsList(newPalette);
    ...
    static BufferedImage load(String chemin){
    ...
    static ArrayList<Pixel> GetPixelsFromImage(BufferedImage image){
    ...
    static BufferedImage MakePalette(ArrayList<Pixel> Lk, int k, BufferedImage image){
        int width = image.getWidth();
    ...
    static BufferedImage Fusion(BufferedImage image, BufferedImage Palette){
        int width = image.getWidth();
